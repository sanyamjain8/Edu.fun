...
const Homepage = () => {
  ...
  return (
    <div className='bg-slate-950'>
      ...
      <div className='flex justify-between px-9 py-8'>
        <div>
          <div className='text-green-600 font-semibold text-4xl'>Edu.fun</div>
          <div className='text-neutral-400'>Find the best Edu.fun tokens and track latest migrations</div>
        </div>
